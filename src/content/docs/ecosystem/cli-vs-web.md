...
NEMAR has two surfaces: the **web app** ([www.nemar.org](https://www.nemar.org)) and the
...
- **Browsing and exploring.** [Discover](https://www.nemar.org/discover), dataset detail pages,
