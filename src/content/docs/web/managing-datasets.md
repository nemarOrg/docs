...
The [dashboard](https://nemar.org/dashboard) is your home base. Every dataset you own appears there, sorted by most recently updated. This page is the dashboard tour in written form, handy if you dismissed the on-screen tour or want a reference.
...
- **Published.** Public, has a DOI, listed on [Discover](https://nemar.org/discover) and indexed by the catalog.
...
- **Your account is pending.** The dashboard, and everything on it, unlocks the moment you verify your email;
  no admin is involved in that step.
  If you can browse the dashboard but can't upload,
  that's a separate, one-time [upload access](/web/upload-access/) grant an admin makes after you request it.
